...
3. Generate a [sequence of functions](https://github.students.cs.ubc.ca/ph1l1pp3/cpsc312-project/blob/a857f05fc7f60da9081581cb7ee4e130046b34d1/prolog/search.pl#L12) which can transform a provided set of inputs into a provided set of outputs, and satisfy a [provided set of path-specific constraints](https://github.students.cs.ubc.ca/ph1l1pp3/cpsc312-project/blob/master/prolog/path_constraints.pl).
...
## Files
- [func_constraints.pl](prolog/func_constraints.pl), [path_constraints.pl](prolog/path_constraints.pl): These file contain function and path constraints, as well as functionality for defining and composing said constraints. Constraints can be used both for rejecting candidate functions and paths, and for scoring them, allowing us to order search results.
...
- [server_test.pl](prolog/server_test.pl): A small client, written in Prolog, which sents a series of requests to the REST API implemented in [server.pl](prolog/server.pl) and tests for correct responses.
